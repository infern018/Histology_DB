  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xl">
      ...
      <DialogContent>
        ...
        {/* add space here (line brea) */}
        <Box mb={2} />

        <Typography variant="body1" gutterBottom>
          Here is a list of standardized stainings and brain parts for your csv.
          (Anyways we would be cleaning your csv for you ^^)
        </Typography>
        ...
        <Button
          ...
          onClick={handleDownloadSample}
        >
          Standardized Stainings and Brain Parts.
        </Button>
